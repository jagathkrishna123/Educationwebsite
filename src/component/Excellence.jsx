  ...
  return (
    <div className="max-w-7xl w-full  mx-auto flex flex-col mt-16 mb-8">
      <div className=" flex flex-col p-6 gap-8">
        ...
        >
          <motion.div
            variants={item} className="flex flex-col items-center justify-center border border-gray-300 rounded-lg p-2 md:p-4 shadow-lg">
          ...
          <motion.div variants={item} className="flex flex-col items-center justify-center border border-gray-300 rounded-lg p-2 md:p-4 shadow-lg">
