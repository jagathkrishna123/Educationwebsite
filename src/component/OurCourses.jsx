  ...
  return (
    <div className="max-w-7xl mx-auto p-2">
      <div className="flex flex-col w-full p-2">
        ...
        <div className="w-full flex flex-row mt-8 px-1">
          <div className="w-full flex flex-col">
            <h2 className="text-[36px] font-bold font-lexend text-[#082A5E]">
              Our <span className="text-[#9116A1]">Featured</span> Courses
            </h2>
          </div>
          <div className="w-full flex flex-row items-center justify-end gap-6 font-hind text-[17px] text-[#39557E] cursor-pointer">
            <p>All Courses</p>
            <p>New One</p>
            <p>Recommended</p>
            <p>Most Placed</p>
